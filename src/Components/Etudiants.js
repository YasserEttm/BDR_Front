...
const Etudiants = ({Type}) => {
    ...
    useEffect(() => {
        fetch("http://localhost:8888/etudiant/"+Type)
          .then((resp) => resp.json())
          .then((data) => setEtudiants(data)); // set data to state
    }, [Type]);
    ...
    const header = (
        <div className="table-header">
            <h5 className="mx-0 my-1">GESTION DES ETUDIANTS</h5>
  ...
  return (
    <div className='home'>
        <div className=" container datatable-crud-demo">
            <div className='d-flex justify-content-center align-center list-text mt-5 mb-3'>LISTE DES ETUDIANTS</div>
            <div className="card">
                <DataTable ref={dt} value={etudiants} selection={selectedEtudiants} onSelectionChange={(e) => setSelectedEtudiants(e.value)}
