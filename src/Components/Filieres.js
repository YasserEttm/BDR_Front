...
const Filieres = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:8888/filieres")
          .then((resp) => resp.json())
    ...
    const header = (
        <div className="table-header">
            <h5 className="mx-0 my-1">GESTION DES FILIERS</h5>
  ...
  return (
    <div className='home'>
        <div className=" container datatable-crud-demo">
            <div className='d-flex justify-content-center align-center list-text mt-5 mb-3'>LISTE DES FILIERES</div>
            <div className="card">
